            ...
            <div class="content-left">
					...
					<div class="text list_1_of_2">
						  <div class="extra-wrap1">
                                        ...
                                        <span class="data">Release Date:<?php echo date('d-M-Y',strtotime($m['release_date'])); ?><br>
                                        Cast:</span><span class="data"><?php echo $m['cast'];?><br>
                                        <b>Description:</b> <?php echo $m['desc'];?></span><br>
                                    </div>
					</div>
