					...
					<div class="about span_1_of_2">	
						<h3><?php echo $movie['movie_name']; ?></h3>	
							...
							<?php
								...
								$shw=mysqli_fetch_array($s);
									...
									<tr>
										...
										<td>
											<?php 
												$ttm=mysqli_query($con,"select  * from tbl_screens where screen_id='".$shw['st_id']."'");
												
												
												$screen=mysqli_fetch_array($ttm);
							...
							<div class="col-md-12 text-center" style="padding-bottom:20px">
								...
								<?php if($date>$_SESSION['dd']){?><a href="booking.php?date=<?php echo date('Y-m-d',strtotime($date . "-1 days"));?>"><button class="btn"></button></a> <?php } ?><span style="cursor:default" class="btn btn-default"><?php echo date('d-M-Y',strtotime($date));?></span>
								<?php if($date!=date('Y-m-d',strtotime($_SESSION['dd'] . "+100 days"))){?>
								<a href="booking.php?date=<?php echo date('Y-m-d',strtotime($date . "+1 days"));?>"><button class="btn"></button></i></a>
								<?php }
								...
								?>
									...
									<tr>
										...
										<button class="book_now" style="width:100%">Book Now</button>
										<?php } ?>
										</form></td>
									</tr>
										</table>
